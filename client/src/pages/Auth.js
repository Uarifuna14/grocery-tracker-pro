...
const Auth = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/');
            window.location.reload(); // Refresh to update the Auth state in App.js
        } catch (err) {
    ...
    return (
        <div className="flex min-h-[80vh] items-center justify-center px-4">
            <div className="w-full max-w-md space-y-8 rounded-[2.5rem] border border-slate-100 bg-white p-10 shadow-2xl shadow-slate-200/50">
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            required 
                            className="w-full rounded-2xl border-slate-200 bg-slate-50 py-4 pl-12 pr-4 text-sm focus:ring-4 focus:ring-emerald-500/10 outline-none"
                        />
                    </div>
                    ...
                    <button 
                        type="submit" 
                        className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-emerald-600 py-4 font-bold text-white transition-all hover:bg-emerald-700 active:scale-95"
                    >
                ...
                <div className="text-center">
                    <button onClick={() => setIsLogin(!isLogin)} className="text-sm font-bold text-emerald-600 hover:text-emerald-700">
